...
function Benefits() {
  return (
    <div className='w-full h-fit flex flex-col items-center gap-8 laptop:gap-16'>
      ...
      <div className='w-full h-fit flex flex-row justify-center font-nohemi400 text-white text-2xl laptop:text-4xl px-4 laptop:px-0'>
        <p className='w-full laptop:w-[60%] text-center'>Empower, Engage, and Elevate Your Blockchain Community</p>
      </div>
      <div className='w-[95%] laptop:w-[85%] h-fit relative'>
