    ...
    >
      ...
      <div className="flex flex-col justify-start gap-8 py-2 h-full">
        ...
        <div
          className={`flex ${
            isMobile
              ? "flex-col gap-8 h-fit"
              : "flex-row justify-between h-[110px]"
          } w-full`}
        >
          {/* Input Mail  */}
          <div
          ...
          {/* Page Links */}
          <div
            className={`flex gap-12 flex-col tablet:flex-row tablet:gap-2 justify-between ${
              isMobile ? "w-full" : "w-[clamp(40%,40%,70%)]"
            }`}
          >
